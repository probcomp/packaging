...
echo "  bayesdb-demo"
echo "  bayesdb-demo --help"
echo "Or you can start a notebook, and import bayeslite or bdbcontrib."
echo "  Pay special attention to bdbcontrib.recipes.quickstart and please"
echo "  do set the session_capture_name with your info."
echo
